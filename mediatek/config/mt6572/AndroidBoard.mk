...
ifeq ($(strip $(MTK_INCLUDE_MODEM_DB_IN_IMAGE)), yes)
  ifeq ($(filter generic banyan_addon banyan_addon_x86,$(PROJECT)),)
    MD1_DATABASE_FILE1 := $(foreach m,$(CUSTOM_MODEM),$(wildcard mediatek/custom/common/modem/$(strip $(m))/BPLGUInfoCustomApp_*_1_2g_*))
    ...
    MD1_DATABASE_FILE2 := $(foreach m,$(CUSTOM_MODEM),$(wildcard mediatek/custom/common/modem/$(strip $(m))/BPLGUInfoCustomApp_*_1_wg_*))
    ...
    MD1_DATABASE_FILE3 := $(foreach m,$(CUSTOM_MODEM),$(wildcard mediatek/custom/common/modem/$(strip $(m))/BPLGUInfoCustomApp_*_1_tg_*))
...
ifeq ($(strip $(MTK_INCLUDE_MODEM_DB_IN_IMAGE)), yes)
  ifeq ($(filter generic banyan_addon banyan_addon_x86,$(PROJECT)),)
    MD2_DATABASE_FILE1 := $(foreach m,$(CUSTOM_MODEM),$(wildcard mediatek/custom/common/modem/$(strip $(m))/BPLGUInfoCustomApp_*_2_2g_*))
    ...
    MD2_DATABASE_FILE2 := $(foreach m,$(CUSTOM_MODEM),$(wildcard mediatek/custom/common/modem/$(strip $(m))/BPLGUInfoCustomApp_*_2_wg_*))
    ...
    MD2_DATABASE_FILE3 := $(foreach m,$(CUSTOM_MODEM),$(wildcard mediatek/custom/common/modem/$(strip $(m))/BPLGUInfoCustomApp_*_2_tg_*))
