...
#if defined(FEATURE_MMC_BOOT_MODE) && !defined(FEATURE_MMC_MEM_PRESERVE_MODE)
struct msdc_cust msdc_cap = {
    ...
    MSDC0_ODC_4MA,	    /* clock pad driving         	*/
    MSDC0_ODC_4MA,	    /* command pad driving       	*/
    MSDC0_ODC_4MA,	    /* data pad driving      		*/
    MSDC0_ODC_4MA,	    /* clock pad driving for 1.8v   */
    MSDC0_ODC_4MA,	    /* command pad driving   1.8V   */
    MSDC0_ODC_4MA,	    /* data pad driving      1.8V   */
    8,                  /* data pins; for FPGA it may be 4*/
    0,                  /* data address offset   */

    /* hardware capability flags     */
	MSDC_HIGHSPEED|MSDC_UHS1//|MSDC_REMOVABLE//|MSDC_HS200
};
...
struct msdc_cust msdc_cap = {
    ...
    MSDC_SMPL_RISING,   /* command latch edge        */
    MSDC_SMPL_RISING,   /* data latch edge       */
    MSDC0_ODC_8MA,     /* clock pad driving         */
    MSDC0_ODC_8MA,     /* command pad driving       */
    MSDC0_ODC_8MA,     /* data pad driving      */
    MSDC0_ODC_8MA,     /* clock pad driving for 1.8v    */
    MSDC0_ODC_8MA,     /* command pad driving   1.8V    */
    MSDC0_ODC_8MA,     /* data pad driving      1.8V    */
    4,                  /* data pins             */
    0,                  /* data address offset       */
