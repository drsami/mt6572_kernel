...
void OV5645MIPIInitialSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3820, 0x47);//	; flip off, V bin on
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3820, 0x46);//	; flip off, V bin off
...
void OV5645MIPI_set_saturation(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case ISP_SAT_LOW:
             OV5645MIPI_write_cmos_sensor(0x5001,0xa3);
			 OV5645MIPI_write_cmos_sensor(0x5580,0x06);
			 OV5645MIPI_write_cmos_sensor(0x5583,0x20);
			 OV5645MIPI_write_cmos_sensor(0x5584,0x20);
             break;
        case ISP_SAT_MIDDLE:
			 OV5645MIPI_write_cmos_sensor(0x5001,0xa3);
...
void OV5645MIPI_set_scene_mode(UINT16 para)
{
    ...
    { 
		...
		case SCENE_MODE_NIGHTSCENE:
			OV5645MIPI_write_cmos_sensor(0x3a00,0x00);
			 OV5645MIPI_write_cmos_sensor(0x3a02,0x0f);
			 OV5645MIPI_write_cmos_sensor(0x3a03,0x60);
			 OV5645MIPI_write_cmos_sensor(0x3a14,0x0f);
			 OV5645MIPI_write_cmos_sensor(0x3a15,0x60);
			 /*CMX*/
			 ...
			 /*Gamma*/	 		 
			 OV5645MIPI_write_cmos_sensor(0x5490,0x1d);
			 OV5645MIPI_write_cmos_sensor(0x5481,0x8 );
			 OV5645MIPI_write_cmos_sensor(0x5482,0x14);
			 OV5645MIPI_write_cmos_sensor(0x5483,0x28);
			 OV5645MIPI_write_cmos_sensor(0x5484,0x51);
			 OV5645MIPI_write_cmos_sensor(0x5485,0x65);
			 ...
			 OV5645MIPI_write_cmos_sensor(0x5308,0x00);
			 OV5645MIPI_write_cmos_sensor(0x5300,0x08);
			 OV5645MIPI_write_cmos_sensor(0x5301,0x30);
			 OV5645MIPI_write_cmos_sensor(0x5302,0x10);
			 OV5645MIPI_write_cmos_sensor(0x5303,0x00);
			 ...
			 OV5645MIPI_write_cmos_sensor(0x3a19,0xfc);
			 /*AE Weight - Average*/ 	 
			 OV5645MIPI_write_cmos_sensor(0x501d,0x00);
        ...
        case SCENE_MODE_PORTRAIT:
			/*Night mode disable*/
			 ...
			 OV5645MIPI_write_cmos_sensor(0x5385,0x65);
			 OV5645MIPI_write_cmos_sensor(0x5386,0x6d);
			 OV5645MIPI_write_cmos_sensor(0x5387,0x63);
			 OV5645MIPI_write_cmos_sensor(0x5388,0x56);
			 ...
			 OV5645MIPI_write_cmos_sensor(0x548f,0xea);			 			 			 
			 /*Sharpness manual 0*/					 		 		 
			 OV5645MIPI_write_cmos_sensor(0x5308,0x40);
			 OV5645MIPI_write_cmos_sensor(0x5302,0x00);			 			 
			  /*ISO Auto - 16x*/
			 OV5645MIPI_write_cmos_sensor(0x3a18,0x00);
			 OV5645MIPI_write_cmos_sensor(0x3a19,0xfc);
			 /*AE Weight - CenterAverage*/ 			 			 
			 OV5645MIPI_write_cmos_sensor(0x501d,0x00); 
			 OV5645MIPI_write_cmos_sensor(0x5688,0x00); 
			 OV5645MIPI_write_cmos_sensor(0x5689,0x00); 
			 OV5645MIPI_write_cmos_sensor(0x568a,0x10); 
			 OV5645MIPI_write_cmos_sensor(0x568b,0x01); 
			 OV5645MIPI_write_cmos_sensor(0x568c,0x10); 
			 OV5645MIPI_write_cmos_sensor(0x568d,0x01); 
			 OV5645MIPI_write_cmos_sensor(0x568e,0x00); 
			 OV5645MIPI_write_cmos_sensor(0x568f,0x00); 			 
            break;
        case SCENE_MODE_LANDSCAPE:
			/*Night mode disable*/
			 ...
			 OV5645MIPI_write_cmos_sensor(0x3a1f,0x14);			 			 		 
			 /*Gamma*/	 		 		 	 			 
			 OV5645MIPI_write_cmos_sensor(0x5490,0x24);
			 OV5645MIPI_write_cmos_sensor(0x5481,0x4 );
			 OV5645MIPI_write_cmos_sensor(0x5482,0x7 );
			 OV5645MIPI_write_cmos_sensor(0x5483,0x10);
			 OV5645MIPI_write_cmos_sensor(0x5484,0x28);
			 OV5645MIPI_write_cmos_sensor(0x5485,0x36);
			 OV5645MIPI_write_cmos_sensor(0x5486,0x44);
			 OV5645MIPI_write_cmos_sensor(0x5487,0x52);
			 OV5645MIPI_write_cmos_sensor(0x5488,0x60);
			 OV5645MIPI_write_cmos_sensor(0x5489,0x6c);
			 OV5645MIPI_write_cmos_sensor(0x548a,0x78);
			 OV5645MIPI_write_cmos_sensor(0x548b,0x8c);
			 OV5645MIPI_write_cmos_sensor(0x548c,0x9e);
			 OV5645MIPI_write_cmos_sensor(0x548d,0xbb);
			 OV5645MIPI_write_cmos_sensor(0x548e,0xd2);
			 OV5645MIPI_write_cmos_sensor(0x548f,0xe5);			 			 			 			 
			 /*Sharpness Auto default*/					 		 		 		 
			 OV5645MIPI_write_cmos_sensor(0x5308,0x00);
			 OV5645MIPI_write_cmos_sensor(0x5300,0x08);
			 OV5645MIPI_write_cmos_sensor(0x5301,0x30);
			 ...
			 /*AE Weight - Average*/ 			 			 	 
			 OV5645MIPI_write_cmos_sensor(0x501d,0x00);
			 OV5645MIPI_write_cmos_sensor(0x5688,0x62);
			 OV5645MIPI_write_cmos_sensor(0x5689,0x26);
			 OV5645MIPI_write_cmos_sensor(0x568a,0xe6);
			 OV5645MIPI_write_cmos_sensor(0x568b,0x6e);
			 OV5645MIPI_write_cmos_sensor(0x568c,0xea);
			 OV5645MIPI_write_cmos_sensor(0x568d,0xae);
			 OV5645MIPI_write_cmos_sensor(0x568e,0xa6);
			 OV5645MIPI_write_cmos_sensor(0x568f,0x6a);			 
             break;
        ...
        case SCENE_MODE_SPORTS:
			 ...
			 OV5645MIPI_write_cmos_sensor(0x530c,0x06);			 
			  /*ISO Auto - 16x*/
			 OV5645MIPI_write_cmos_sensor(0x3a18,0x01);
			 OV5645MIPI_write_cmos_sensor(0x3a19,0xfc);
			 /*AE Weight - Average*/ 			 
			 OV5645MIPI_write_cmos_sensor(0x501d,0x00);
			 OV5645MIPI_write_cmos_sensor(0x5688,0x11);
...
void OV5645MIPI_set_iso(UINT16 para)
{
    ...
    switch (para)
    {
        case AE_ISO_100:
             //ISO 100
             OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
             OV5645MIPI_write_cmos_sensor(0x3a19, 0x30);
             break;
        case AE_ISO_200:
             //ISO 200
             OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
        ...
        case AE_ISO_400:
             //ISO 400
             OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
             OV5645MIPI_write_cmos_sensor(0x3a19, 0x80);
             break;
        default:
             break;
    }
    ...
    {	
       case AE_EV_COMP_20:	                   
		...
		case AE_EV_COMP_10:	                   
			  ...
			  break;
		case AE_EV_COMP_00:
				OV5645MIPI_write_cmos_sensor(0x3a0f, 0x38);//	; AEC in H
				OV5645MIPI_write_cmos_sensor(0x3a10, 0x30);//	; AEC in L
				OV5645MIPI_write_cmos_sensor(0x3a11, 0x70);//	; AEC out H
				OV5645MIPI_write_cmos_sensor(0x3a1b, 0x38);//	; AEC out L
				OV5645MIPI_write_cmos_sensor(0x3a1e, 0x30);//	; control zone H
				OV5645MIPI_write_cmos_sensor(0x3a1f, 0x18);//	; control zone L  
			  break;
   		 case AE_EV_COMP_n10:
				OV5645MIPI_write_cmos_sensor(0x3a0f, 0x26);//	; AEC in H
				OV5645MIPI_write_cmos_sensor(0x3a10, 0x1f);//	; AEC in L
				OV5645MIPI_write_cmos_sensor(0x3a11, 0x4c);//	; AEC out H
				OV5645MIPI_write_cmos_sensor(0x3a1b, 0x26);//	; AEC out L
				OV5645MIPI_write_cmos_sensor(0x3a1e, 0x1f);//	; control zone H
...
UINT32 OV5645MIPIFeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId,UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
        ...
        case SENSOR_FEATURE_SET_AE_WINDOW:
            OV5645MIPISENSORDB("AE zone addr = 0x%x\n",*pFeatureData32);			
