...
#ifdef MTK_MT6620
static ap_nvram_btradio_mt6610_struct stBtDefault_6620 =
{
...
#ifdef MTK_MT6628
static ap_nvram_btradio_mt6610_struct stBtDefault_6628 =
{
    {0x00, 0x00, 0x46, 0x66, 0x28, 0x01},
    {0x60, 0x00},
#if defined(MTK_MERGE_INTERFACE_SUPPORT)
// 6628 PCM_I2S_MERGE_PIN
    {0x63, 0x10, 0x00, 0x00},
#else
    {0x23, 0x10, 0x00, 0x00},
#endif
...
static ap_nvram_btradio_mt6610_struct stBtDefault_6572 =
{
