...
UINT32 S5K4ECGX_MIPI_GetSensorID(UINT32 *sensorID)
{
   ...
   do {
        ...
        *sensorID = S5K4ECGX_read_cmos_sensor(0x0F12);
        SENSORDB("[4EC]Read Sensor ID = 0x%04x\n", *sensorID);
        ...
        SENSORDB("[4EC]Read Sensor ID Fail = 0x%04x\n", *sensorID);
        retry--;
   } while (retry > 0);
    ...
    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    spin_lock(&s5k4ecgx_mipi_drv_lock);
    pSensorInfo->CaptureDelayFrame = (0 == S5K4ECGX_Driver.manualAEStart) ? 3 : 2;
    spin_unlock(&s5k4ecgx_mipi_drv_lock);
...
void S5K4ECGX_MIPI_GetExifInfo(UINT32 exifAddr)
{
    ...
    pExifInfo->RealISOValue = S5K4ECGX_Driver.isoSpeed;
}




void S5K4ECGX_MIPI_GetDelayInfo(UINT32 delayAddr)
{
               ...
               UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_SET_YUV_3A_CMD:
             ...
             S5K4ECGX_MIPI_3ACtrl((ACDK_SENSOR_3A_LOCK_ENUM)*pFeatureData32);
             break;
        ...
        case SENSOR_FEATURE_GET_DELAY_INFO:
             ...
             S5K4ECGX_MIPI_GetDelayInfo(*pFeatureData32);
             break;
        ...
        case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
             ...
             S5K4ECGX_MIPI_get_AEAWB_lock((*pFeatureData32),*(pFeatureData32+1));
             break;
