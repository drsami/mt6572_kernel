...
struct part_name_map g_part_name_map[PART_MAX_COUNT] = {
	...
	{"uboot",	PART_UBOOT,	"raw data",	8,	0,	0},
	{"boot",	PART_BOOTIMG,	"raw data",	9,	1,	1},
	{"recovery",	PART_RECOVERY,	"raw data",	10,	0,	0},
	{"sec_ro",	PART_SECSTATIC,	"raw data",	11,	0,	0},
	{"misc",	PART_MISC,	"raw data",	12,	0,	0},
	{"logo",	PART_LOGO,	"raw data",	13,	0,	0},
