...
MTK_CGEN_TARGET_CFG	:= $(MTK_CGEN_OUT_DIR)/cgencfg/tgt_cnf
MTK_CGEN_HOST_CFG	:= $(MTK_CGEN_OUT_DIR)/cgencfg/pc_cnf
MTK_CGEN_EXECUTABLE	:= $(MTK_CGEN_OUT_DIR)/Cgen
...
MTK_CGEN_AP_Editor2_Temp_DB	:= $(MTK_CGEN_OUT_DIR)/APDB2_$(MTK_PLATFORM)_$(MTK_CHIP_VER)_$(MTK_BRANCH)_$(MTK_WEEK_NO)
...
$(eval $(call mtk-cgen-AutoGenHeaderFile,$(MTK_CGEN_cfg_module_file_dir),$(MTK_CGEN_cfg_module_file),,out/target/product/$(PROJECT)/obj/include/dfo/CFG_Dfo_File.h))
$(eval $(call mtk-cgen-AutoGenHeaderFile,$(MTK_CGEN_cfg_module_default_dir),$(MTK_CGEN_cfg_module_default),,out/target/product/$(PROJECT)/obj/include/dfo/CFG_Dfo_Default.h))
...
$(eval $(call mtk-cgen-PreprocessFile,$(MTK_CGEN_APDB_SourceFile),$(MTK_CGEN_AP_Temp_CL),$(MTK_CGEN_COMPILE_OPTION) -I. -I$(MTK_CGEN_CUSTOM_DIR)/$(strip $(MTK_PROJECT))/cgen/inc -I$(MTK_CGEN_CUSTOM_COMMON_DIR)/inc,$(DEAL_STDOUT_CODEGEN) || $(SHOWRSLT) $$$${PIPESTATUS[0]} $(CODEGEN_LOG)))
...
$(MTK_CGEN_AP_Temp_CL): out/target/product/$(PROJECT)/obj/include/dfo/CFG_Dfo_File.h
$(MTK_CGEN_AP_Temp_CL): out/target/product/$(PROJECT)/obj/include/dfo/CFG_Dfo_Default.h
...
MTK_BTCODEGEN_catcher_ps_db_path := $(MTK_BTCODEGEN_ROOT)/../../database/BTCatacherDB
