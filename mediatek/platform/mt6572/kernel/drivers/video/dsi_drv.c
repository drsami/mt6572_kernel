...
void DSI_PHY_clk_setting(LCM_PARAMS *lcm_params)
{
    ...
    if(0!=(AS_UINT32(0xF0009180)&0x000000F0))
    {      
      dsi_bg_r2_trim = (AS_UINT32(&DSI_PHY_REG->MIPITX_DSI_BG_CON)&0xF0000000)>>28;
      dsi_bg_r2_trim += (AS_UINT32(0xF0009180)&0x000000F0)>>4;
    ...
    if(0!=(AS_UINT32(0xF0009180)&0x0000000F))
    {      
      dsi_bg_r1_trim = (AS_UINT32(&DSI_PHY_REG->MIPITX_DSI_BG_CON)&0x0F000000)>>24;
      dsi_bg_r1_trim += AS_UINT32(0xF0009180)&0x0000000F;
  ...
  //Special case for internal phone card detection pin mux with MIPI data lane 2 TX
    ...
    if(0!=(AS_UINT32(0x10009180)&0x000000F0))
    {    
      dsi_bg_r2_trim = (AS_UINT32(&DSI_PHY_REG->MIPITX_DSI_BG_CON)&0xF0000000)>>28;
      dsi_bg_r2_trim += (AS_UINT32(0x10009180)&0x000000F0)>>4;
      dsi_bg_r2_trim = dsi_bg_r2_trim & 0xF;
      OUTREGBIT(MIPITX_DSI_BG_CON_REG,DSI_PHY_REG->MIPITX_DSI_BG_CON,RG_DSI_BG_R2_TRIM,dsi_bg_r2_trim);
    }
    if(0!=(AS_UINT32(0x10009180)&0x0000000F))
    {      
      dsi_bg_r1_trim = (AS_UINT32(&DSI_PHY_REG->MIPITX_DSI_BG_CON)&0x0F000000)>>24;
      dsi_bg_r1_trim += AS_UINT32(0x10009180)&0x0000000F;
      dsi_bg_r1_trim = dsi_bg_r1_trim & 0xF;
      OUTREGBIT(MIPITX_DSI_BG_CON_REG,DSI_PHY_REG->MIPITX_DSI_BG_CON,RG_DSI_BG_R1_TRIM,dsi_bg_r1_trim);
    }
